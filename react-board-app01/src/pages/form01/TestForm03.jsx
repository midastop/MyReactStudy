...
export default function TestForm03() {
  ...
  return (
        ...
        <form onSubmit={ handleSubmit }>        
          ...
          <input type="text" name="writer" id="writer" className="form-control" 
            value={ values.writer } onChange={ handleChange } />
          { errors.writer && <span style={{color: 'red'}}>{ errors.writer }<br/></span> }<br/>
          ...
          { errors.pass && <span  className="text-danger">{ errors.pass }<br/></span> }<br/>  
          <label htmlFor="content" className="form-label" >내용 : </label>
          <textarea type="text" name="content" id="content"className="form-control"  
            value={ values.content } onChange={ handleChange } rows="5" />
          { errors.content && <span className="text-danger">{ errors.content }<br/></span> }<br/>
